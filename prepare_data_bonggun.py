...
print ("dict 0: %s" % segmented_data[0])


for i in segmented_data:
    paragraphs_list.append({"paragraph_id": i["paragraph_id"], "text": i["sentences"],
                            "article": i["Name"], "section": i["Section"]})
...
for k, v in p_data.iteritems():
    for i in v:
        question = {"question": i["question"], "paragraph_id": i["paragraph_id"]}
        all_questions.append(question)
